                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col">
                            ...
                            <input class="form-control" type="text" name="filtro_postal" id="filtro_postal"
                                data-placeholder="Ingrese un nombre a filtrar" style="width: 100%;">
                        </div>
                ...
                <div class="card-body">
                    ...
                    <div align="left">
                        <button type="button" name="create_record" id="create_record"
                            class="btn btn-success btn-sm">Crear Nueva localidad</button>
                        ...
                        <table class='table table-bordered table-striped table-hover datatable' id='data-table'>
                            ...
                            <tbody style="background-color:white ; color:black;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" name="edit" id="{{$localidad->id}}"
                                            class="edit btn btn-outline-primary btn-sm">Editar</button>
                                        &nbsp;&nbsp;
                                        <button type="button" name="delete" id="{{$localidad->id}}"
