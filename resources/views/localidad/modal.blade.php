            ...
            <form method="post" id="sample_form" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group col">
                        ...
                        <input type="text" name="codigoPostal" id="codigoPostal" required placeholder="Ingrese un codigo postal"
                            class="form-control" />
                    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form id="formDelete" action="{{route('localidad.destroy')}}" method="POST">
                    @csrf
                    @method('DELETE')
...
<script>
    ...
    $(document).ready(function(){
        ...
        function filtro_funcion(){
            ...
            var filtro_postal = $('#filtro_postal').val().trim().toUpperCase() ;
        ...
        $('#create_record').click(function(){
            $('#form_result').html('');
            $("#sample_form").attr("action","{{route('localidad.store')}}");
            $('.modal-title').text("Agregar Nueva localidad");
        ...
        $(document).on('click', '.edit', function(){
            var id = $(this).attr('id');
            $("#sample_form").attr("action","{{route('localidad.update')}}");
            $('#form_result').html('');
            $.ajax({
                url:"/localidades/"+id+"/edit",
                contentType: false,
                cache:false,
                processData: false,
                dataType:"json",
