    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form id="formDelete" action="{{route('provincia.destroy')}}" method="POST">
                    @csrf
                    @method('DELETE')
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#create_record').click(function(){
            $('#form_result').html('');
            $("#sample_form").attr("action","{{route('provincia.store')}}");
            $('.modal-title').text("Agregar Nueva provincia");
        ...
        $(document).on('click', '.edit', function(){
            var id = $(this).attr('id');
            $("#sample_form").attr("action","{{route('provincia.update')}}");
            $('#form_result').html('');
            $.ajax({
                url:"/provincia/"+id+"/edit",
                contentType: false,
                cache:false,
                processData: false,
                dataType:"json",
                success:function(html){
                    ...
                    $('.modal-title').text("Editar provincia");
