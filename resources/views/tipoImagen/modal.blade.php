    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form id="formDelete" action="{{route('tipoImagen.destroy')}}" method="POST">
                    @csrf
                    @method('DELETE')
...
<script>
    ...
    $(document).ready(function(){
            ...
            $('#create_record').click(function(){
                $('#form_result').html('');
                $("#sample_form").attr("action","{{route('tipoImagen.store')}}");
                $('.modal-title').text("Agregar Nuevo Tipo de Imagen");
            ...
            $(document).on('click', '.edit', function(){
                var id = $(this).attr('id');
                $("#sample_form").attr("action","{{route('tipoImagen.update')}}");
                $('#form_result').html('');
                $.ajax({
                    url:"/tipoImagen/"+id+"/edit",
                    contentType: false,
                    cache:false,
                    processData: false,
                    dataType:"json",
                    success:function(html){
                        ...
                        $('.modal-title').text("Editar Tipo de Imagen");
