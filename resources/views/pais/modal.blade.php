    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form id="formDelete" action="{{route('pais.destroy')}}" method="POST">
                    @csrf
                    @method('DELETE')
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#create_record').click(function(){
            $('#form_result').html('');
            $("#sample_form").attr("action","{{route('pais.store')}}");
            $('.modal-title').text("Agregar Nuevo Pais");
        ...
        $(document).on('click', '.edit', function(){
            var id = $(this).attr('id');
            $("#sample_form").attr("action","{{route('pais.update')}}");
            $('#form_result').html('');
            $.ajax({
                url:"/pais/"+id+"/edit",
                contentType: false,
