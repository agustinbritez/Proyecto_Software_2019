		...
		<div class="col-sm-12">
				...
				<div class="card-body">
					...
					<div class="row">
						...
						<div class="form-group col-md-3">
							...
							<select class="select2"  name="filtro_operacion" id="filtro_operacion" data-placeholder="Seleccione Una Operacion"
							style="width: 100%;">
			...
			<div class="card text-left">
				...
				<div class="card-body">
					...
					<div align="left">
						<button type="button" name="create_record" id="create_record" class="btn btn-success btn-sm">Crear Nuevo Tipo Movimiento</button>
						...
						<table class='table table-bordered table-striped table-hover datatable' id='data-table'>
							...
							<tbody style="background-color:white ; color:black;">
								...
								<tr>
									...
									@endif
									<th >
										<button type="button" name="edit" id="{{$movi->id}}" class="edit btn btn-outline-primary btn-sm">Editar</button>
										&nbsp;&nbsp;
										<button type="button" name="delete" id="{{$movi->id}}" class="delete btn btn-outline-danger btn-sm">Eliminar</button>
