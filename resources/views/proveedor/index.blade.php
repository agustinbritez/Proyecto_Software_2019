			...
			<div class="card text-left">
				...
				<div class="row">
					...
					<div class="form-group col-md-3">
						...
						<input class="form-control"  type="text" name="filtro_documento" id="filtro_documento" data-placeholder="Ingrese un nombre a filtrar"
						style="width: 100%;">
					</div>
					<div class="form-group col-md-3">
						<label>Email : </label>
						<input class="form-control"  type="text" name="filtro_email" id="filtro_email" data-placeholder="Ingrese un nombre a filtrar"
						style="width: 100%;">
					</div>
