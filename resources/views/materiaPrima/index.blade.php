			...
			<div class="card text-left">
				...
				<div class="card-body">
					<div align="left">
						...
						<a type="button"  href="{{route('materiaPrima.pdf')}}" class="btn btn-success btn-flat btn-sm">Reporte Materia Prima</a>
					</div>
					<hr>
				...
				<table class='table table-bordered table-striped table-hover datatable' id='data-table'>
					...
					<tbody style="background-color:white ; color:black;">
						...
						<tr>
							...
							{{-- <th>Imagen Principal</th> --}}
							<th >
								<button type="button" name="edit" id="{{$materia->id}}" class="edit btn btn-primary btn-sm">Editar</button>
								&nbsp;&nbsp;
								<button type="button" name="delete" id="{{$materia->id}}" class="delete btn btn-danger btn-sm">Eliminar</button>
