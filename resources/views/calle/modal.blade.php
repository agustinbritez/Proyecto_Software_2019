    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form id="formDelete" action="{{route('calle.destroy')}}" method="POST">
                    @csrf
                    @method('DELETE')
...
<script>
    $(document).ready(function(){
        ...
        $('#create_record').click(function(){
            $('#form_result').html('');
            $("#sample_form").attr("action","{{route('calle.store')}}");
            $('.modal-title').text("Agregar Nueva calle");
        ...
        $(document).on('click', '.edit', function(){
            var id = $(this).attr('id');
            $("#sample_form").attr("action","{{route('calle.update')}}");
            $('#form_result').html('');
            $.ajax({
                url:"/callees/"+id+"/edit",
                contentType: false,
